...
public class MousePicker3D {
    ...
    public MousePicker3D(EditorCamera cam, Matrix4f projection, Terrain terrain) {
        editorCamera = cam;
        projectionMatrix = projection;
        viewMatrix = Maths.createViewMatrix(editorCamera);
    ...
    private Vector3f calculateMouseRay() {
        float mouseX = MouseListener.getScreenX();
        float mouseY = MouseListener.getScreenY();
    ...
    private Vector3f getPointOnRay(Vector3f ray, float distance) {
        Vector3f camPos = editorCamera.getPosition();
