...
//    public Material(Texture texture) { this.texture = texture; }
    ...
    public Material(String filepath, Map<String, Object> data) {
        ...
        this.data = data;
        this.texture = Loader.get().loadTexture(this.data.get("albedo").toString());
    }
...
//        return this.metallicMap.getTextureID() != 0 && this.metallicIntensity > 0;
        return this.metallicMap.getTextureID() != 0;
    }
...
//        return this.specularMap.getTextureID() != 0 && this.specularIntensity > 0;
        return this.specularMap.getTextureID() != 0;
    }
...
//        return this.emissionMap.getTextureID() != 0 && this.emissionIntensity > 0;
        return this.emissionMap.getTextureID() != 0;
    }
...
//    public void setUseAlbedoEmission(boolean useAlbedoEmission) { this.useAlbedoEmission = useAlbedoEmission; }
    ...
    public void setTiling(Vector2f tiling) {
        this.data.replace("tiling", tiling);
        this.tiling = tiling;
    }
    ...
    public float getAlphaClip() { return 1; }

    public void setAlphaClip(float alphaClip) { }

    public float getShineDumper() { return 10; }

    public void setShineDumper(float shineDumper) { }

    public float getReflectivity() { return 0; }

    public void setReflectivity(float reflectivity) {  }

    public RenderCullSide getCullSide() { return RenderCullSide.Both; }

    public void setCullSided(RenderCullSide cullSide) {  }

    public boolean isUseFakeLighting() { return false; }
